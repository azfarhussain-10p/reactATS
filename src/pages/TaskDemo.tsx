      ...
      <Grid container spacing={4}>
          ...
          <Card>
            <CardContent>
              ...
              <Typography variant="body2" paragraph>
                The Queue Service provides functionality to process long-running tasks
                asynchronously in the background, improving the responsiveness of the main
                application.
              </Typography>
              <Divider sx={{ my: 2 }} />
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ p: 3, height: '100%' }}>
            ...
            <Typography variant="body2" paragraph>
              The TaskManager component provides a UI for monitoring and managing asynchronous
              tasks. It displays active tasks, allows for cancellation, and shows task history.
            </Typography>
            <Divider sx={{ my: 2 }} />
            <Typography variant="subtitle2" gutterBottom>
              Try it out:
        ...
        <DialogContent>
          <Box component="form" noValidate sx={{ mt: 1 }}>
            <TextField
              ...
              onChange={(e) =>
                setCurrentTask((prev) => (prev ? { ...prev, title: e.target.value } : prev))
              }
            />
            <TextField
              margin="normal"
              ...
              onChange={(e) =>
                setCurrentTask((prev) => (prev ? { ...prev, description: e.target.value } : prev))
              }
            />
            <Box display="flex" gap={2} mt={2}>
              <TextField
                ...
                onChange={(e) =>
                  setCurrentTask((prev) => (prev ? { ...prev, assignee: e.target.value } : prev))
                }
              />
              <TextField
                required
                ...
                onChange={(e) =>
                  setCurrentTask((prev) => (prev ? { ...prev, dueDate: e.target.value } : prev))
                }
                InputLabelProps={{
                  shrink: true,
                }}
            ...
            <Box display="flex" gap={2} mt={2}>
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  onChange={(e) =>
                    setCurrentTask((prev) =>
                      prev ? { ...prev, priority: e.target.value as any } : prev
                    )
                  }
                >
