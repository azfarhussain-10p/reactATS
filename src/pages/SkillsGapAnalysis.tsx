...
const mockSkills = [
  ...
  { name: 'Product Management', category: 'Management', demand: 68, supply: 55, trend: 'increasing' },
  ...
  { name: 'Machine Learning', category: 'Data Science', demand: 80, supply: 45, trend: 'increasing' },
];
    ...
    <Box sx={{ maxWidth: 1200, mx: 'auto', py: 3, px: 2 }}>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary">
          Identify skill gaps in your organization and plan strategic hiring and training initiatives.
        </Typography>
      </Box>
        ...
        <Grid item xs={12} md={4}>
          <Card>
            <CardContent>
              ...
              <Typography variant="h4">
                {Math.round(filteredSkills.reduce((sum, skill) => sum + (skill.demand - skill.supply), 0) / filteredSkills.length)}%
              </Typography>
              <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
                ...
                <TableRow key={skill.name}>
                  ...
                  <TableCell>
                    <Typography 
                      ...
                      fontWeight="medium"
                    >
                      {skill.demand > skill.supply ? '+' : ''}{skill.demand - skill.supply}%
                    </Typography>
                  </TableCell>
                  <TableCell>
                    ...
                    .map(skill => (
                      <Box key={skill.name} sx={{ mb: 1 }}>
                        ...
                        <Typography variant="caption" color="text.secondary">
                          {skill.category} • Gap: {skill.demand - skill.supply}% • {skill.trend.charAt(0).toUpperCase() + skill.trend.slice(1)} demand
                        </Typography>
                      </Box>
                    ))
                  }
                  ...
                  {filteredSkills
                    ...
                    .map(skill => (
                      <Box key={skill.name} sx={{ mb: 1 }}>
                        ...
                        <Typography variant="caption" color="text.secondary">
                          {skill.category} • Demand: {skill.demand}% • Current supply: {skill.supply}%
                        </Typography>
                      </Box>
                    ))
                  }
                  ...
                  {filteredSkills
                    ...
                    .map(skill => (
                      <Box key={skill.name} sx={{ mb: 1 }}>
                        ...
                        <Typography variant="caption" color="text.secondary">
                          {skill.category} • Current capability: {skill.supply}% • Target: {Math.min(skill.supply + 15, 100)}%
                        </Typography>
                      </Box>
                    ))
                  }
            ...
            <Card variant="outlined">
              <CardContent>
                ...
                <Typography variant="body2" component="div">
                  • Allocate 40% of training budget to upskilling in {filteredSkills.filter(s => s.demand - s.supply > 15)[0]?.category || 'high-demand areas'}
                </Typography>
                <Typography variant="body2" component="div">
