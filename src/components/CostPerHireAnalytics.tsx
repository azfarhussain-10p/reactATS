...
const costCategories: CostCategory[] = [
  { id: '1', name: 'Advertising', description: 'Job board postings, social media ads, etc.', isDirectCost: true },
  { id: '2', name: 'Agency Fees', description: 'Recruitment agency and headhunter fees', isDirectCost: true },
  { id: '3', name: 'Referral Bonuses', description: 'Employee referral program payouts', isDirectCost: true },
  { id: '4', name: 'Background Checks', description: 'Pre-employment screening and verification', isDirectCost: true },
  { id: '5', name: 'Recruiting Events', description: 'Career fairs, networking events, etc.', isDirectCost: true },
  { id: '6', name: 'ATS Software', description: 'Applicant tracking system subscription', isDirectCost: false },
  { id: '7', name: 'HR Time', description: 'HR team time spent on recruiting activities', isDirectCost: false },
  { id: '8', name: 'Hiring Manager Time', description: 'Time spent by hiring managers in the process', isDirectCost: false },
  { id: '9', name: 'Onboarding', description: 'New hire orientation and training', isDirectCost: false }
];

// Sample cost data
const sampleCostItems: CostItem[] = [
  { id: '1', categoryId: '1', name: 'LinkedIn Job Premium', amount: 2500, department: 'Engineering' },
  { id: '2', categoryId: '1', name: 'Indeed Sponsored Listings', amount: 1800, department: 'Sales' },
  { id: '3', categoryId: '2', name: 'Tech Recruiter Agency', amount: 12000, department: 'Engineering' },
  { id: '4', categoryId: '3', name: 'Referral Bonuses Paid', amount: 3000, department: 'Engineering' },
  { id: '5', categoryId: '4', name: 'Background Check Service', amount: 1200, department: 'All' },
  { id: '6', categoryId: '5', name: 'Tech Conference Booth', amount: 5000, department: 'Engineering' },
  { id: '7', categoryId: '6', name: 'ATS Monthly Subscription', amount: 1500, department: 'All' },
  { id: '8', categoryId: '7', name: 'Recruiter Salaries (Allocated)', amount: 22000, department: 'All' },
  { id: '9', categoryId: '8', name: 'Interview Hours (Calculated)', amount: 8500, department: 'Engineering' },
  { id: '10', categoryId: '8', name: 'Interview Hours (Calculated)', amount: 4200, department: 'Sales' },
...
const CostPerHireAnalytics: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      const totalSpecificDeptCost = Object.values(byDepartment).reduce((sum, cost) => sum + cost, 0);
        ...
        <>
          ...
          <Grid container spacing={3} sx={{ mb: 4 }}>
            ...
            <Grid item xs={12} md={4}>
              <Card elevation={2}>
                <CardContent>
                  <Typography variant="h6" sx={{ mb: 2 }}>Direct vs Indirect Costs</Typography>
            ...
            <Grid item xs={12} md={4}>
              <Card elevation={2}>
                <CardContent>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                    <Typography variant="body2" color="text.secondary">
                      Advertising: {Math.round((costSummary.byCategory['Advertising'] || 0) / costSummary.totalCost * 100)}%
                    </Typography>
                    <Typography variant="body2" color="text.secondary">
                      Agency: {Math.round((costSummary.byCategory['Agency Fees'] || 0) / costSummary.totalCost * 100)}%
                    </Typography>
                    <Typography variant="body2" color="text.secondary">
                      HR Time: {Math.round((costSummary.byCategory['HR Time'] || 0) / costSummary.totalCost * 100)}%
                    </Typography>
                  </Box>
                </CardContent>
              </Card>
                        ...
                        {Object.entries(costSummary.byDepartment).map(([dept, cost]) => {
                          ...
                          return (
                            <TableRow key={dept}>
                              ...
                              >
                                {vsAverage > 0 ? '+' : ''}{formatCurrency(vsAverage)}
                              </TableCell>
                            </TableRow>
                          );
                        })}
                    ...
                    <Table size="small">
                      ...
                      <TableBody>
                        <TableRow>
                          ...
                          <TableCell align="right">{formatCurrency(costSummary.costPerHire)}</TableCell>
                        ...
                        <TableRow>
                          ...
                          <TableCell 
                            align="right"
                            sx={{ 
                              color: costSummary.costPerHire - 4950 > 0 ? 'error.main' : 'success.main'
                            }}
                          >
                        ...
                        <TableRow>
                          ...
                          <TableCell 
                            align="right"
                            sx={{ 
                              color: costSummary.costPerHire - 5200 > 0 ? 'error.main' : 'success.main'
                            }}
                          >
                        ...
                        <TableRow>
                          ...
                          <TableCell 
                            align="right"
                            sx={{ 
                              color: costSummary.costPerHire - 4100 > 0 ? 'error.main' : 'success.main'
                            }}
                          >
                        ...
                        <TableRow>
                          ...
                          <TableCell 
                            align="right"
                            sx={{ 
                              color: costSummary.costPerHire - 4800 > 0 ? 'error.main' : 'success.main'
                            }}
                          >
                        ...
                        <TableRow>
                          ...
                          <TableCell 
                            align="right"
                            sx={{ 
                              color: costSummary.costPerHire - 5500 > 0 ? 'error.main' : 'success.main'
                            }}
                          >
