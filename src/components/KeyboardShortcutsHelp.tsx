...
const KeyboardShortcutsHelp: React.FC = () => {
  ...
  const shortcuts: KeyboardShortcut[] = [
    ...
    { key: 'Alt+K', description: 'Show keyboard shortcuts (this dialog)', category: 'accessibility' },
      ...
      >
        ...
        <DialogContent dividers>
          <Typography variant="body2" color="text.secondary" paragraph>
            The following keyboard shortcuts are available throughout the application to improve efficiency and accessibility.
            Press <KeyboardKey keyText="Esc" /> to close this dialog.
          </Typography>
