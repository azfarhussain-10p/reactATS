...
export const ScreenReaderAnnouncer: React.FC<ScreenReaderAnnouncerProps> = ({
  ...
  useEffect(() => {
    ...
    (window as any).announceToScreenReader = (
      message: string,
      customPoliteness?: 'polite' | 'assertive'
    ) => {
    ...
    const handleAuthChange = () => {
      ...
      announcementQueue.current = announcementQueue.current.filter((item) =>
        item.message.includes('logged out')
      );
  ...
  return (
    <>
      ...
      <div aria-live="assertive" className="sr-only-announcement" role="alert">
        {politeness === 'assertive' ? announcement : ''}
      </div>
      <div aria-live="polite" className="sr-only-announcement" role="status">
