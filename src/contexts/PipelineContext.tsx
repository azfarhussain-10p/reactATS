...
const defaultPipelineStages = [
  ...
  {
    id: 'Technical Assessment' as PipelineStage,
...
const defaultPipelines: RecruitmentPipeline[] = [
  ...
  },
  {
    ...
    stages: [
      ...
      {
        id: 'Pair Programming' as PipelineStage,
  ...
  },
  {
    ...
    stages: [
      ...
      {
        id: 'First Interview' as PipelineStage,
      ...
      {
        id: 'Team Interview' as PipelineStage,
      ...
      {
        id: 'Reference Check' as PipelineStage,
      ...
      {
        id: 'Final Interview' as PipelineStage,
        name: 'CEO Interview',
        order: 5,
        daysToComplete: 5,
        requiredTasks: [],
